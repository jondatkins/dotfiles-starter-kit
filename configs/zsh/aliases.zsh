...
alias vim="nvim"
alias zshrc="vim ${DOTFILES}/zsh/.config/zsh/.zshrc"
alias aliases="vim ${DOTFILES}/zsh/.config/zsh/.my_aliases"
alias funcs="vim ${DOTFILES}/zsh/.config/zsh/.my_functions"
alias zshrcs="source ${DOTFILES}/zsh/.config/zsh/.zshrc"
alias vimrc="vim ${DOTFILES}/nvim/.config/nvim/lua/config/lazy.lua"
